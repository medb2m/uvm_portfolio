...
import { SiTailwindcss, SiCplusplus, SiCsharp, SiMysql, SiOracle, SiSymfony, SiTypescript, SiSpring } from 'react-icons/si';

const Skills = () => {
  return (
    <div className='max-w-4xl mx-auto my-8 p-8 rounded-lg bg-white shadow-lg' id='skills'>
      <h2 className='text-4xl font-bold mb-4 text-center hover:text-[#A020F0]'>Skills</h2>
